...
export function createClient() {
  ...
  if (!supabaseUrl) {
    ...
    console.error(`CLIENT Supabase Config Error: NEXT_PUBLIC_SUPABASE_URL is invalid or still a placeholder: '${supabaseUrl}'. Ensure your .env file has the correct URL (starting with https://) and the server was restarted.`);
